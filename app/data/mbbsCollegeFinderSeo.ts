...
export const mbbsCollegeFinderSeoParagraphs = [
  ...
  "For MBBS abroad, NEET qualification and budget are the main starting points, and domicile does not apply.",
  "Rank within 30,000 generally means government MBBS should be explored first through MCC and state counselling strategy.",
  "Abroad results will later suggest three countries first, then maximum two best-fit colleges per country, with other colleges shown as backup options.",
  "This tool is not a guarantee of admission.",
  "Final guidance requires eligibility review, documents, budget, seat availability and official approval.",
];
