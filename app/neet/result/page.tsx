...
export const metadata: Metadata = {
  title: "NEET Result | Official Score Path | ILMALINK MEDIGO",
  description:
    "Official NEET result and score verification path from trusted source pages.",
  alternates: {
    ...
    <main className="min-h-screen bg-[#F8FAFC] text-slate-950">
      ...
      <section className="mx-auto max-w-5xl px-4 pb-12 pt-8 sm:px-6 sm:pt-10 lg:px-8">
        ...
        <p className="mt-4 text-base font-medium leading-7 text-slate-700">
          Verify NEET scorecard and result updates from official sources only.
        </p>
        ...
        <div className="mt-6 rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
          ...
          >
            Open official NEET result source
